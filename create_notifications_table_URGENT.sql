-- URGENT: Create notifications table for task notifications
-- Run this directly in your Supabase SQL Editor

-- Drop table if it exists (in case there are conflicts)
...
-- Test the table by inserting a sample record (will be deleted)
...
SELECT 
  ...
  'unread'
WHERE EXISTS (SELECT 1 FROM families LIMIT 1) 
