-- Drop any existing function with the same name first
...
-- Create the function with explicit table reference
...
DECLARE
  new_task_id uuid;
BEGIN
  -- Insert the task into family_tasks (explicitly specify public schema)
